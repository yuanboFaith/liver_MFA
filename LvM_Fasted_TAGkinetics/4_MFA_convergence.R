...
if (state_fasted.or.refed == "fasted") {
  ...
  d.13C.labeling <- d.13C.fasted.TAGkinetics
  totalCO2       <- 1800 
}
...
load(file = "../data/cleaned_labeling_data_Fasted_TAGkinetics.RData")
...
# func.process_tracer(tracer.k = "13CLinoKinA")
# func.process_tracer(tracer.k = "13CLinoKinB")
# func.process_tracer(tracer.k = "13CLinoKinC")
# func.process_tracer(tracer.k = "13CLinoKinD")
# func.process_tracer(tracer.k = "13CLinoKinG")
# func.process_tracer(tracer.k = "13CLinoKinH")
# func.process_tracer(tracer.k = "13CLinoKinO")
# func.process_tracer(tracer.k = "13CLinoKinP")
# func.process_tracer(tracer.k = "13CLinoKinQ")
# func.process_tracer(tracer.k = "13CLinoKinR")
# func.process_tracer(tracer.k = "13CLinoKinS")
# func.process_tracer(tracer.k = "13CLinoKinT")



# Create a cluster
cl <- makeCluster(9+11, outfile = "" )  
...
ordered.tracers = paste0(
  "13C", c("Glc", "Lac", "Ala", "Gln", "Glycerol", "HB", "Palm", "Ole", "Lino", 
           paste0("LinoKin", c("A", "B", "C", "D", "G", "H", "I", "P", "Q", "R", "S", "T"))))
...
ggsave(filename = "./plots/sim vs obs.pdf", width = 20, height = 12)
