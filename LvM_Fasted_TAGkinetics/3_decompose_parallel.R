...
if (state_fasted.or.refed == "fasted") {
  ...
  params <- list(
    ...
    "13CPalm"     = list(myTracer = "13CPalm",     tracerInputRate = 32), # infusion rate is the C2 unit equivalent rate; 
    "13COle"      = list(myTracer = "13COle",      tracerInputRate = 18), # infusion rate is the C2 unit equivalent rate; 
    "13CLino"     = list(myTracer = "13CLino",     tracerInputRate = 36), # infusion rate is the C2 unit equivalent rate; 
...
#     "13CGln"      = list(myTracer = "13CGln",      tracerInputRate = 10),
#     "13CPalm"     = list(myTracer = "13CPalm",     tracerInputRate = 16),  # infusion rate is the C2 unit equivalent rate; 
#     "13COle"      = list(myTracer = "13COle",      tracerInputRate = 36),  # infusion rate is the C2 unit equivalent rate; 
#     "13CLino"     = list(myTracer = "13CLino",     tracerInputRate = 28.8),# infusion rate is the C2 unit equivalent rate; 
